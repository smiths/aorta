...
\item[\refstepcounter{acnum} \actheacnum \label{acGetInput}:] The methods to get the inputs from the user.
...
R4 & \mref{{mDisplay}}\\
NFR1 & \mref{mHH}, \mref{mInput}, \mref{mParams}, \mref{mControl}\\
NFR2 & \mref{mInput}, \mref{mParams}\\
NFR3 & \mref{mVerify}\\
NFR4 & \mref{mOutput}, \mref{mControl}\\
\bottomrule
\end{tabular}
