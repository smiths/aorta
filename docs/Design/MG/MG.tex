...
\item [\refstepcounter{mnum} \mthemnum \label{mNDAP}:] Multidimensional Array Processing Module
\item [\refstepcounter{mnum} \mthemnum \label{mDE}:] Digital Enhancement Module
\item ...
\end{description}
