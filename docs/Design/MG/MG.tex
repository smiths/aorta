...
\item[\refstepcounter{acnum} \actheacnum \label{acVisualize}:] The methods to visualize the processing data (volume).
...
\item[Services:]Povide GUI software for user to write inputs, and send commands to the program. It could include the rendering a windows, inputs, keyboard and mouse interaction with the GUI elements.
