...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/AC/SRS/NonFunctional_Requirements.png}}
...
The purpose of the Design Document \cite{DD} is to explain in details how the algorithm works, and why it worked. Similar to what section \ref{algo} wrote, the design document explains in plan text the workflow of the algorithm. Since before the domain expert can agree on the design and implementation, the person needs to understand the algorithm, we are building a Design Document that is easy to access. 
...
\subsection{Tool used in Algorithm Review}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.9\textwidth]{figures/AC/AR/variable-explorer-standard.png}}
    \caption[Spyder Variable Explorer]{Spyder Variable Explorer}
    \label{fig_spyder_ve}
\end{figure}
