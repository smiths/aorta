...
%\begin{itemize}
%\item {import any DICOM files, input the required parameters, and begin the segmentation effortlessly}
%\end{itemize} 
%
%For a valid image, the AortaGeomRecon provides a correct solution, or no
%answer.
%The user interface and documentation should allow a user that meets
%the user characteristics (Section 3.2) to learn how to do an aorta segmentation in at
%least 30% of the time it takes to learn and use ITK-Snap (bubble method mentioned
%in Section 2).
