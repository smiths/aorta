...
class AortaGeomReconDisplayModule(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.title = "AortaGeomReconDisplayModule"  # TODO: make this more human readable by adding spaces
        self.parent.categories = ["Segmentation"]  # TODO: set categories (folders where the module shows up in the module selector)
        self.parent.dependencies = ["Markups"]  # TODO: add here list of module names that this module requires
...
def registerSampleData():
    ...
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        ...
        thumbnailFileName=os.path.join(iconsPath, 'AortaGeomReconDisplayModule1.png'),
    ...
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        ...
        thumbnailFileName=os.path.join(iconsPath, 'AortaGeomReconDisplayModule2.png'),
        # Download URL and target file name
...
class AortaGeomReconDisplayModuleLogic(ScriptedLoadableModuleLogic):
...
class AortaGeomReconDisplayModuleTest(ScriptedLoadableModuleTest):
    """
